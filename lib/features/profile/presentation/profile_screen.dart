...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void didChangeDependencies() {
    ...
    optionDisplayed
        .sink.add(AppLocalizations.of(context)!.male);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocBuilder<UserProfileBloc, UserInfoState>(
            bloc: _bloc,
            buildWhen: (pre , cur) {
              return cur is GetUserInfoStateLoading || cur is GetUserInfoStateSuccess || cur is GetUserInfoStateError ;
            },
          ...
          if (state is GetUserInfoStateLoading) {
            ...
            genderDisplayed.sink.add(state.model.genderStr??AppLocalizations.of(context)!.male);
            optionDisplayed.sink.add(state.model.genderStr??AppLocalizations.of(context)!.male);
            hasInsuranceDisplayed.sink.add(state.model.hasInsurance == true ?AppLocalizations.of(context)!.yes : AppLocalizations.of(context)!.no);
            insuranceOptionDisplayed.sink.add(state.model.hasInsurance == true ?AppLocalizations.of(context)!.yes : AppLocalizations.of(context)!.no);
                    ...
                    children: [
                      BlocListener(
                        bloc: _bloc,
                          ...
                          listenWhen: (pre , cur) {
                            return cur is UpdateUserInfoStateLoading || cur is UpdateUserInfoStateSuccess || cur is UpdateUserInfoStateError ;
                          },
                          listener: (c , state)async{
                            if(state is UpdateUserInfoStateLoading){
                              await LoadingDialogs.showLoadingDialog(context);
                            }
                            else if (state is UpdateUserInfoStateSuccess)
                            {
                              ...
                              UpdateUserInfoStateError myState = (state as UpdateUserInfoStateError );
                              LoadingDialogs.hideLoadingDialog();
                              CoolAlert.show(
                                context: context,
                                autoCloseDuration: const Duration(seconds: 1),
                      ...
                      GenericTextField(
                        ...
                        hintStyle: AppStyles.baloo2FontWith400WeightAnd14Size
                                ...
                                [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      insuranceOptionDisplayed.value == item ?
                                      const  Icon(Icons.check_circle, color: primaryColor,size: 15,):
                                      const SizedBox()
                                    ],
                                  ),
        ...
        onPressed: () {
          _bloc.updateUserData(
            UpdateUserRequest(
                ...
                haveInsurance: hasInsuranceDisplayed.value == AppLocalizations.of(context)!.yes,
