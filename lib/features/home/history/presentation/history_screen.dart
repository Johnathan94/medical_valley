                                  ...
                                  child: StreamBuilder<int>(
                                      ...
                                      builder: (context, snapshot) {
                                        return Column(
                                          ...
                                          children: AppInitializer.sortChoices
                                              .map((e) => Padding(
                                            padding: smallPaddingAll,
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  MainAxisAlignment
                                                      .spaceBetween,
                                                  children: [
                                                    Text(AppInitializer.sortChoices[AppInitializer.sortChoices.indexOf(e)].sortOption),
                                                    sortOption
                                                        .value ==
                                                        AppInitializer.sortChoices
                                                            .indexOf(
            ...
            child: Row(
              ...
              children:  [
                ...
                Column(
                  ...
                  children:  [
                    Text("some place",style: AppStyles.baloo2FontWith400WeightAnd18Size.copyWith(color: Colors.grey, decoration: TextDecoration.none,),),
                    const SizedBox(
                        height: 17,
                    ),
                    Text("some place",style: AppStyles.baloo2FontWith500WeightAnd15Size.copyWith(color: primaryColor),),
                  ],
                ),
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${items.address}", style: AppStyles.baloo2FontWith400WeightAnd18SizeAndBlack,),
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
        ...
        child: Text(title ,style: AppStyles.baloo2FontWith400WeightAnd20SizeAndBlack.copyWith(color: whiteColor),),
