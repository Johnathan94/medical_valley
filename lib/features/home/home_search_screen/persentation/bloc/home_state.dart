...
class LoadingPackageState extends MyHomeState {}
...
class ErrorPackageState extends MyHomeState {
  ErrorStates states;

  ErrorPackageState(this.states);
}
...
class SuccessPackageState extends MyHomeState {
  PackageResponse response;

  SuccessPackageState(this.response);
}
