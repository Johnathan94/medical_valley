  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocBuilder<MedicalFileBloc, MedicalInfoState>(
            bloc: _bloc,
            buildWhen: (pre , cur) {
              return cur is MedicalInfoStateLoading || cur is MedicalInfoStateSuccess || cur is MedicalInfoStateError ;
            },
                  ...
                  children: [
                    BlocListener(
                      bloc: _bloc,
                        ...
                        listenWhen: (pre , cur) {
                          return cur is SetMedicalInfoStateLoading || cur is SetMedicalInfoStateSuccess || cur is SetMedicalInfoStateError ;
                        },
                        listener: (c , state)async{
                          if(state is SetMedicalInfoStateLoading){
                            await LoadingDialogs.showLoadingDialog(context);
                          }
                          else if (state is SetMedicalInfoStateSuccess)
                          {
                            ...
                            SetMedicalInfoStateError myState = (state as SetMedicalInfoStateError );
                            LoadingDialogs.hideLoadingDialog();
                            CoolAlert.show(
                              context: context,
                              autoCloseDuration: const Duration(seconds: 1),
