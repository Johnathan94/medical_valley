...
class RegisterMedicalFileScreen extends StatefulWidget {
  final bool openFirstTime;
  const RegisterMedicalFileScreen({required this.openFirstTime, Key? key})
      : super(key: key);

  @override
  State<RegisterMedicalFileScreen> createState() =>
      _RegisterMedicalFileScreenState();
}

class _RegisterMedicalFileScreenState extends State<RegisterMedicalFileScreen> {
